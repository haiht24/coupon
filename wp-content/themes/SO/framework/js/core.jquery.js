  ...
  var methods = {
    init: function(settings) {
      ...
      self.stars.on('click.raty', function(evt) {
        ...
        self.score.val((self.opt.half || self.opt.precision) ? that.data('score') : $(this).attr("data-score"));
	...
	if(this.opt.scoreName == "off"){
      ...
      for (var i = 1; i <= this.opt.number; i++) {
        ...
        $('<span />', { class : icon + " size"+ this.opt.size + " readonly" + this.opt.readOnly , 'data-score':i,  title: title, }).appendTo(this);
      ...
      for (var i = 1; i <= self.stars.length; i++) {
        ...
        if (self.opt.iconRange && self.opt.iconRange.length > hash) {
          ...
          if (i <= irange.range) {
            star.attr('class',  icon + " size"+this.opt.size + " readonly" + this.opt.readOnly  );
          }
          ...
          star.attr('class',  this.opt[icon] + " size"+this.opt.size + " readonly" + this.opt.readOnly );
        }
      }
