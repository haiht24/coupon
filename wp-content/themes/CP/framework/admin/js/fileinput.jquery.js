 ...
 */
 jQuery.fn.customFileInput = function(options){
	...
	fileInput
		...
		var upload = jQuery('<div class="customfile">');
		//create custom control feedback
		var uploadFeedback = jQuery('<div class="uneditable-input ' + settings.classes + '" aria-hidden="true"><span>' + settings.feedback_text + '</span></div>').appendTo(upload);
		//create custom control button
		var uploadButton = jQuery('   <span class="add-on btn">Upload</span>');
